...
struct Service {
    ...
    static func fetchUsers(completion: @escaping([User]) -> Void) {
        ...
        // Fetch message and sender of the message
    ...
    static func fetchConversations(completion: @escaping([Conversation]) -> Void) {
        ...
        // Accessing database to fetch messages
    ...
    static func uploadMessage(_ message: String, to user: User, completion: ((Error?) -> Void)?) {
        ...
        COLLECTION_MESSAGES.document(currentUid).collection(user.uid)
            .addDocument(data: data) { _ in COLLECTION_MESSAGES.document(user.uid).collection(currentUid).addDocument(data: data, completion: completion)
